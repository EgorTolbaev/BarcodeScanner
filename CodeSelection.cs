...
{
    [Activity(Label = "Barcode Scanner", Icon = "@drawable/icon", Theme = "@style/Theme.AppCompat.Light.NoActionBar")]
    class CodeSelection : AppCompatActivity, ISurfaceHolderCallback, IProcessor
    {
